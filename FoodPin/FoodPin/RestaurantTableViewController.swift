    ...
    func configureDataSource() -> UITableViewDiffableDataSource<Section, String> {
        ...
        let dataSource = UITableViewDiffableDataSource<Section, String>(
            ...
            cellProvider: { tableView, indexPath, _ in
                ...
                cell.configureCell(name: self.restaurantNames[indexPath.row], location: self.restaurantLocations[indexPath.row], type: self.restaurantTypes[indexPath.row], image: self.restaurantImages[indexPath.row])
                return cell
            }
        )
        return dataSource
